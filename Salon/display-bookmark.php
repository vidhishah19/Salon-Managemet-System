...
while($planrow= mysqli_fetch_array($selectq))
{
    ...
    echo "<td><a href=''><img style='width:16px' src='images/edit.png'>Edit</a> | <a href='display-bookmark.php?did={$planrow['bookmark_id']}'><img style='width:16px' src='images/delete.png'>Delete</a></td>";
    echo "</tr>";
}
?>
<!--
