...
<div class="shop-item">
<div class="top">
    <img src="assets/images/ZionSalon.jpg">
<ul>
<li><!--
...
<p>Zion Salons in Ahmedabad is led by KARRA BEAUTY PVT. LTD. aimed to provide world class Beauty services.
The goal at Zion Salons is to help every client experience real beauty, not just from the outside, but most importantly from deep within. The Team at Zion Salons will ensure that every client’s needs are anticipated and each unique experience becomes an unforgettable journey to real beauty.</p>
<ul class="tag">
