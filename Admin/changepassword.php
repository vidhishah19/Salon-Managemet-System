...
if($_POST)
{
    ...
    $oldpasswordfromdb= mysqli_fetch_row($oldpasswordquey);
    ...
    <div class="log-w3">
        <div class="w3layouts-main">
            ...
            <form action="#" method="post">
                <input type="password" class="ggg" name="opass" placeholder="Old Password" required>
                <input type="password" class="ggg" name="npass" placeholder="New Password" required>
                <input type="password" class="ggg" name="cpass" placeholder="Confirm Password" required>
