...
$selectq= mysqli_query($connection, "select * from tbl_schedule where schedule_id='{$editid}'") or die(mysqli_error($connection));
                        ...
                        <div class="panel-body">
                            <div class="position-center">
                                <form role="form" method="post" enctype="multipart/form-data">
                                    <input type="hidden" name="sdid" value="<?php echo $selectrow['schedule_id'] ?>">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="datetime-local" class="form-control" value="<?php echo $selectrow['start_time'] ?>" name="stime" placeholder="Enter Start Time" required>
                                </div>
                                <div class="form-group">
                                    <label for="exampleInputEmail1">End Time:</label>
                                    <input type="datetime-local" class="form-control" value="<?php echo $selectrow['end_time'] ?>" name="etime" placeholder="Enter End Time" required>
                                </div>
