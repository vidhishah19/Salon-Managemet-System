            ...
            <div class="col-lg-12">
                    <section class="panel">
                        <header class="panel-heading">
                            Add Membership Plans For Salon
                        </header>
                        <div class="panel-body">
                            <div class="position-center">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="pname" placeholder="Enter Plan's Name" required>
                                </div>
                                    
                                <div class="form-group">
                                    <label for="exampleInputEmail1">Price:</label>
                                    <input type="text" class="form-control" name="pprice" placeholder="Enter Price" required>
                                </div>
                                
                                <div class="form-group">
                                    <label for="exampleInputEmail1">Duration:</label>
                                    <input type="text" class="form-control" name="pduration" placeholder="Enter Plan's Duration" required>
                                </div>
