...
var EWR_SESSION_URL = EWR_RELATIVE_PATH + "ewrsession9.php"; // Session URL
...
var EWR_LOGOUT_URL = EWR_RELATIVE_PATH + "rlogout.php"; // Logout URL
var EWR_DISABLE_BUTTON_ON_SUBMIT = true;
var EWR_IMAGES_FOLDER = "phprptimages/"; // Image folder
var EWR_LOOKUP_FILE_NAME = "ewrajax9.php"; // Lookup file name
...
<?php } ?>
<?php if (@$gsExport == "" || @$gsExport == "print" || @$gsExport == "email" && @$gsEmailContentType == "url") { ?>
<script type="text/javascript">if (!window.jQuery) ewr_GetScript("jquery/jquery-1.12.0.min.js");</script>
<?php } ?>
<?php if (@$gsExport == "" || @$gsExport == "print" || @$gsExport == "email" && @$gsEmailContentType == "url") { ?>
...
<script type="text/javascript">
var EWR_CHART_EXPORT_HANDLER = "<?php echo ewr_ConvertFullUrl("fcexporter9.php") ?>";
</script>
<?php } ?>
...
<script type="text/javascript">if (window.jQuery && typeof Moment === 'undefined') ewr_GetScript("phprptjs/moment.min.js");</script>
<script type="text/javascript">ewr_GetScript("phprptjs/ewr9.js");</script>
<script type="text/javascript">
...
<script type="text/javascript">ewr_GetScript("phprptjs/ewrusrfn9.js");</script>
<script type="text/javascript">

// Write your client script here, no need to add script tags.
</script>
<?php } ?>
<link rel="shortcut icon" type="image/vnd.microsoft.icon" href="<?php echo ewr_ConvertFullUrl("logo_ombre.ico") ?>"><link rel="icon" type="image/vnd.microsoft.icon" href="<?php echo ewr_ConvertFullUrl("logo_ombre.ico") ?>">
<meta name="generator" content="PHP Report Maker v9.0.1">
</head>
<body>
...
<div class="ewLayout">
	...
	<div id="ewHeaderRow" class="<?php echo $gsHeaderRowClass ?>"><img src="<?php echo $EWR_RELATIVE_PATH ?>phprptimages/phprptmkrlogo9.png" alt=""></div>
