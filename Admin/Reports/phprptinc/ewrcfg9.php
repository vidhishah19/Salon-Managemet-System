...
define("EWR_PROJECT_ID", "{3C488A29-896C-4371-BB76-02105C3C2105}", TRUE); // Project ID
...
$EWR_CONN["DB"] = array("conn" => NULL, "id" => "DB", "type" => "MYSQL", "host" => "localhost", "port" => 3306, "user" => "root", "pass" => "", "db" => "sdp_database", "qs" => "`", "qe" => "`");
...
// General
$EWR_ROOT_RELATIVE_PATH = "..\..\..\Users\VIDHI SHAH\Documents\PHP Report Maker\WebSites\project1"; // Relative path of app root
...
define("EWR_RANDOM_KEY", 'XPP11hLOUYo9Mq2q', TRUE); // Random key for encryption
