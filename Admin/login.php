...
if($_POST)
{
    ...
    $selectquery= mysqli_query($connection, "select * from tbl_user where email='{$email}' and password='{$password}'") or die(mysqli_error($connection));
    ...
    {
        echo "<script>alert('Admin details did not match. Please register!');</script>";
    }
}
