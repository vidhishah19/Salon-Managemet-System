                        ...
                        <div class="panel-body">
                            <div class="position-center">
                                <form role="form" method="post" enctype="multipart/form-data">
                                    <input type="hidden" name="sid" value="<?php echo $selectrow['service_id'] ?>">
                                <div class="form-group">
                                    <label for="exampleInputEmail1">Service Name:</label>
                                    <input type="text" class="form-control" value="<?php echo $selectrow['service_name'] ?>" name="svname" placeholder="Enter Service Name" required>
                                </div>
                                
                                <div class="form-group">
                                    <label for="exampleInputEmail1">Service Details:</label>
                                    <textarea class="form-control" name="svdetails" required><?php echo $selectrow['service_details'] ?></textarea>
                                </div>
                                    
                                <div class="form-group">
                                    <label for="exampleInputEmail1">Service Image:</label>
                                    <input type="file" id="exampleInputFile" value="<?php echo $selectrow['service_image'] ?>" name="svimage" required>
