...
if($query)
{
    $fileprocess= move_uploaded_file($_FILES['upicture']['tmp_name'], $upicture);
                        ...
                        <div class="panel-body">
                            <div class="position-center">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="exampleInputEmail1" name="uname" placeholder="Enter User's Name" required>
                                </div>
                                    
                                <div class="form-group">
                                    <label for="exampleInputEmail1">Gender:</label>
                                    <input type="text" class="form-control" id="exampleInputEmail1" name="ugender" placeholder="Enter User's Gender" required>
                                </div>
                                    
                                <div class="form-group">
                                    <label for="exampleInputEmail1">Email:</label>
                                    <input type="email" class="form-control" id="exampleInputEmail1" name="uemail" placeholder="Enter Email" required>
                                </div>
                                    
                                <div class="form-group">
                                    <label for="exampleInputEmail1">Password:</label>
                                    <input type="password" class="form-control" id="exampleInputPassword1" name="upassword" placeholder="Enter Password" required>
                                </div>
                                    
                                <div class="form-group">
                                    <label for="exampleInputEmail1">Phone No.:</label>
                                    <input type="text" class="form-control" id="exampleInputEmail1" name="uphone" placeholder="Enter Phone No." required>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="file" id="exampleInputFile" name="upicture" accept="image/*">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="date" class="form-control" id="exampleInputEmail1" name="udob" placeholder="Enter User's DateOfBirth" required>
                                </div>
