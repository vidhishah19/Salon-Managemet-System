...
<section id="main-content">
 ...
 <div class="panel panel-default">
    <div class="panel-heading">
     ...
     <a href="add-schedule.php"><i class="glyphicon glyphicon-plus"></i>ADD</a>
    <div>
...
while($planrow= mysqli_fetch_array($selectq))
{
    ...
    echo "<td><a href='edit-schedule.php?eid={$planrow['schedule_id']}'><img style='width:16px' src='images/edit.png'>Edit</a> | <a href='display-schedule.php?did={$planrow['schedule_id']}'><img style='width:16px' src='images/delete.png'>Delete</a></td>";
    echo "</tr>";
}
?>
<!--
