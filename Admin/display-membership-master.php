...
<section id="main-content">
 ...
 <div class="panel panel-default">
    <div class="panel-heading">
     ...
     <a href="add-membership-master.php"><i class="glyphicon glyphicon-plus"></i>ADD</a>
    <div>
...
while($planrow= mysqli_fetch_array($selectq))
{
    ...
    echo "<td><a href='edit-membership-master.php?eid={$planrow['membership_plan_id']}'><img style='width:16px' src='images/edit.png'>Edit</a> | <a href='display-membership-master.php?did={$planrow['membership_plan_id']}'><img style='width:16px' src='images/delete.png'>Delete</a></td>";
    echo "</tr>";
}
?>
<!--
