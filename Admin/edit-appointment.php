...
$selectq= mysqli_query($connection, "select * from tbl_appointment where appointment_id='{$editid}'") or die(mysqli_error($connection));
                        ...
                        <div class="panel-body">
                            <div class="position-center">
                                <form role="form" method="post" enctype="multipart/form-data">
                                    <input type="hidden" name="apid" value="<?php echo $selectrow['appointment_id'] ?>">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="exampleInputEmail1" value="<?php echo $selectrow['duration'] ?>" name="apduration" placeholder="Enter Appointment's Duration" required>
                                </div>
                                    
                                <div class="form-group">
                                    <label for="exampleInputEmail1">Details:</label>
                                    <textarea class="form-control" name="apdetails" required><?php echo $selectrow['appointment_details'] ?></textarea>
                                </div>
                                    
                                <div class="form-group">
                                    <label for="exampleInputEmail1">Start Time:</label>
                                    <input type="datetime-local" class="form-control" id="exampleInputEmail1" value="<?php echo $selectrow['start_time'] ?>" name="stime" placeholder="Enter Start Time" required>
                                </div>
