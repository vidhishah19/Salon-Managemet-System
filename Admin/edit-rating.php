...
$selectq= mysqli_query($connection, "select * from tbl_rating where rating_id='{$editid}'") or die(mysqli_error($connection));
                        ...
                        <div class="panel-body">
                            <div class="position-center">
                                <form role="form" method="post" enctype="multipart/form-data">
                                    <input type="hidden" name="rid" value="<?php echo $selectrow['rating_id'] ?>">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" value="<?php echo $selectrow['ratings'] ?>" name="rating" placeholder="Enter Rating:" required>
                                </div>
                                <div class="form-group">
                                    <label for="exampleInputEmail1">Date of Rating:</label>
                                    <input type="date" class="form-control" value="<?php echo $selectrow['rating_date'] ?>" name="rdate" placeholder="Enter Date of Rating:" required>
                                </div>
