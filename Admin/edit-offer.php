...
$selectq= mysqli_query($connection, "select * from tbl_offers where offer_id='{$editid}'") or die(mysqli_error($connection));
                        ...
                        <div class="panel-body">
                            <div class="position-center">
                                <form role="form" method="post" enctype="multipart/form-data">
                                    <input type="hidden" name="oid" value="<?php echo $selectrow['offer_id'] ?>">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" value="<?php echo $selectrow['offer_type'] ?>" name="otype" placeholder="Enter Offer Type:" required>
                                </div>
                                <div class="form-group">
                                    <label for="exampleInputEmail1">Offer Details:</label>
                                    <textarea class="form-control"  name="odetails" required><?php echo $selectrow['offer_details'] ?></textarea>
                                </div>
