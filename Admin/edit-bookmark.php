...
$selectq= mysqli_query($connection, "select * from tbl_bookmarks where bookmark_id='{$editid}'") or die(mysqli_error($connection));
...
$query= mysqli_query($connection, "insert into tbl_bookmarks(user_id,salon_id) values('{$uid}','{$sid}')") or die(mysqli_error($connection));
                        ...
                        <div class="panel-body">
                            <div class="position-center">
                                <form role="form" method="post" enctype="multipart/form-data">
                                    <input type="hidden" name="bkid" value="<?php echo $selectrow['service_id'] ?>">
                                ...
                                <button type="button" onclick="window.location='display-bookmark.php';" class="btn btn-info">View</button>
                            </form>
                            </div>
