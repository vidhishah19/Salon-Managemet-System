...
while($userrow= mysqli_fetch_array($selectq))
{
    ...
    echo "<td><a href='edit-user.php?eid={$userrow['user_id']}'><img style='width:16px' src='images/edit.png'>Edit</a> | <a href='display-user.php?did={$userrow['user_id']}'><img style='width:16px' src='images/delete.png'>Delete</a></td>";
    echo "</tr>";
}
